...
public class AttendanceEmployeemFormController implements Initializable {
    ...
    public void doneBTN(ActionEvent actionEvent) {
        ...
        try{
            if(crudUtil.execute("INSERT INTO employeeattendance VALUES (?,?,?,?,?)",sa.getaId(),sa.getYear(),sa.getMonth(),sa.getDate(),sa.getStatus())){
