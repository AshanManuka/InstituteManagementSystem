...
public class AttendanceTeachermFormController implements Initializable {
    ...
    public void doneBTN(ActionEvent actionEvent) {
        ...
        try{
            if(crudUtil.execute("INSERT INTO teacherattendance VALUES (?,?,?,?,?)",sa.getaId(),sa.getYear(),sa.getMonth(),sa.getDate(),sa.getStatus())){
