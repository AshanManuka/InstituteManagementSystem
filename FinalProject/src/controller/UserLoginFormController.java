...
public class UserLoginFormController {
    ...
    private void setLogin() throws SQLException, ClassNotFoundException, IOException {
        ...
        ResultSet result1 = crudUtil.execute("SELECT userId FROM systemUser WHERE userName=?",uName);
        ResultSet result2 = crudUtil.execute("SELECT userId FROM systemUser WHERE password=?",uPass);
